"""Main experiment script: Baseline vs EntityNormalization on JacRED dev subset."""
...
def main():
    ...
    # TODO: Add EntityNormalization condition here
    # entity_norm_results = run_entity_norm_condition(...)
    ...
    # TODO: Print EntityNorm row once implemented
    # e = entity_norm_results["aggregate"]
    # print(f"{'EntityNorm':>12} {e['precision']:>10.2f} {e['recall']:>8.2f} {e['f1']:>6.2f} {e['tp']:>5} {e['fp']:>5} {e['fn']:>5}")
    ...
    output = {
        ...
        "conditions": {
            ...
            # "entity_normalization": entity_norm_results,
        },
    }
