...
**Key issue**: Recall is very low (0.16-0.22). One contributing factor is poor entity alignment -- the LLM may extract entities with names that don't exactly match gold vertexSet mentions, causing misalignment and inflating both FP and FN counts.
...
- Compare: Baseline vs Two-Stage vs Entity-Normalized
